...
public class GraphTime extends JPanel implements ActionListener,ChangeListener {
	private static final Logger log = LogManager.getLogger("GraphTime");
	...
	public GraphTime(Bats main, String type, int corrIndex) {
		...
		JLabel textLabel = new JLabel("Correction:", SwingConstants.LEFT);  		
		textLabel.setAlignmentX(Component.RIGHT_ALIGNMENT);
		JLabel textLabel2 = new JLabel("%/h", SwingConstants.LEFT);  		
	    ...
	    dataSet = Func.getXY_err(data.get(dataType),plotIndex,x,y,x_multi,y_multi);
