 ...
 */
abstract class Corr {
	private static final Logger log = LogManager.getLogger("Corr");
...
//	public Double nom;
	...
	Corr(StdNom stdNom) {
		this.stdNom = stdNom;
		blank = new StdBl("Blank mean", "used", true, Setting.autocalc);
		blankR = new StdBl("Mean", "of samples",false, false);
		blankS = new StdBl("Mean", " sample scatter", false, false);
		std = new StdBl("Std mean", "used",  true, Setting.autocalc);
		stdR = new StdBl("Mean", "of runs", false, false);
		stdS = new StdBl("Mean", "of samples", false, false);
		stdSc = new StdBl("Mean", "sample scatter", false, false);
		timeCorr = 0.0;
		constBG=0.0;
		constBGErr=0.0;
		constBlWeight=0.0;
...
class StdBl implements DataSet {
	private static final Logger log = LogManager.getLogger("StdBl");
