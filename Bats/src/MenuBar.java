...
public class MenuBar extends JMenuBar implements ActionListener{
	...
	private static final Logger log = LogManager.getLogger("MenuBar");
	Action action;
...
//	// Check that we are on Mac OS X.  This is crucial to loading and using the OSXAdapter class.
	...
	public MenuBar(Action action) {
	    ...
	    this.add(menu);
		log.debug("Added the following menue: "+menu.getText());
		...
		if (Setting.getActive("/bat/isotope/db")) {       
		    ...
		    this.add(menu1);
			log.debug(String.format("Added the following menue: %s", menu1.getText()));
		}
...
//	    menu2.setMnemonic(KeyEvent.VK_C);
	    ...
	    this.add(menu2);
		log.debug("Added the following menue: "+menu2.getText());
	    ...
	    this.add(menu3);
		log.debug("Added the following menue: "+menu3.getText());
	    ...
	    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab1"),KeyEvent.VK_1);
	    ...
	    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab2"),KeyEvent.VK_2);
	    ...
	    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab3"),KeyEvent.VK_3);
	    ...
	    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab4"),KeyEvent.VK_4);
	    ...
	    if (Setting.isotope.contains("C14")) {
		    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab5"),KeyEvent.VK_5);
	    ...
	    if (Setting.isotope.contains("P")) {
		    ...
		    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab8"),KeyEvent.VK_8);
	    ...
	    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab6"),KeyEvent.VK_6);
	    ...
	    menuItem = new JMenuItem(Setting.getString("/bat/isotope/tab_pane/tab7"),KeyEvent.VK_7);
	    ...
	    menuItem = new JMenuItem("Cycle table",KeyEvent.VK_9);
	    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_9,  MENU_MASK));
	    menuItem.getAccessibleContext().setAccessibleDescription("");
	    menuItem.setName("Cycle settings");
	    menuItem.addActionListener(this);
	    menu4.add(menuItem);
		log.debug("Added the following menue: "+menu4.getText());
...
//		    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L,  MENU_MASK));
	    ...
	    menuItem = new JMenuItem("Increase font size in output",KeyEvent.VK_PLUS);
	    ...
	    menuItem.addActionListener(this);
	    menu5.add(menuItem);
		log.debug("Added the following menue: "+menu5.getText());
...
//	    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,  MENU_MASK));
    ...
    public void menu_update() {
	    JMenuItem menuItem;
		log.debug("Updare menue.");
	
	    menu.removeAll();
	    
	    //group of JMenuItems
	    menuItem = new JMenuItem("Open data file...");
	    if (Setting.getActive("/bat/isotope/db/sql")) {menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,  MENU_MASK));}
...
//	    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,  MENU_MASK));
	    ...
	    menuItem = new JMenuItem("Open hv files... (new)");
//	    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,  MENU_MASK));
	    menuItem.getAccessibleContext().setAccessibleDescription("Opens data files from directory");
	    menuItem.setName("Open HV dir... (new)");
	    menuItem.addActionListener(this);
	    menu.add(menuItem);
...
//		}
	...
	//		menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_1, MENU_MASK));
		...
		if (Setting.getActive("/bat/isotope/db")) {       
			...
			menuItem = new JMenuItem("Load new data...");
			...
			menuItem = new JMenuItem("Load latest data");
		    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L,  MENU_MASK));
			...
			menuItem = new JMenuItem("Update data");
		    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U,  MENU_MASK));
		    menuItem.getAccessibleContext().setAccessibleDescription("Update data from database");
		    menuItem.setName("Update db");
		    menuItem.addActionListener(this);
		    menuItem.setEnabled(!Setting.no_data);
		    menu1.add(menuItem);
			...
			if (Setting.getActive("/bat/isotope/db/sql")) {       
			    ...
			    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,  MENU_MASK));
			    menuItem.getAccessibleContext().setAccessibleDescription("Open from database");
...
//			if (Setting.isotope.contains("C14")) {
			    menuItem = new JMenuItem("Constant background",KeyEvent.VK_C);
//			    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_I,  MENU_MASK));
			    menuItem.getAccessibleContext().setAccessibleDescription("Constant background correction");
...
//	    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C,  MENU_MASK));
	    ...
	    if (Setting.isotope.equalsIgnoreCase("c14")) {
			    ...
			    if (System.getProperty("user.name").equalsIgnoreCase("lukas")||System.getProperty("user.name").equalsIgnoreCase("wacker")) {				
					    ...
					    menuItem = new JMenuItem("Save calibration");
					    menuItem.getAccessibleContext().setAccessibleDescription("Save annual calibation curve to a xml-excel file");
					    menuItem.setName("Save calibration");
					    menuItem.addActionListener(this);
					    menu3.add(menuItem);
