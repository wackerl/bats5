...
public class GraphCurrent extends JPanel implements ActionListener, ChangeListener {
	private static final Logger log = LogManager.getLogger("GraphCurrent");
	...
	public GraphCurrent(Bats main, String type, int corrIndex) {
		...
		JLabel textLabel = new JLabel("Current correction:", SwingConstants.LEFT);  		
		textLabel.setAlignmentX(Component.RIGHT_ALIGNMENT);
		JLabel textLabel2 = new JLabel(" % / µA", SwingConstants.LEFT);  		
	...
	nf.setAllowsInvalid(true);
		...
		JLabel textLabel3 = new JLabel("   Offset: ", SwingConstants.LEFT);  		
		...
		JLabel textLabel4 = new JLabel("µA", SwingConstants.LEFT);  		
	    ...
	    dataSet = Func.getXY_err(data.get(dataType),corrIndex,x,y,x_multi,y_multi);
	...
	XYErrorRenderer renderer = new XYErrorRenderer();
        ...
        XYPlot plot = new XYPlot(
        	dataset,
        	new NumberAxis(Setting.getString("/bat/isotope/graph/"+type+"/x_axes")),     // x axis label
        	new NumberAxis(Setting.getString("/bat/isotope/graph/"+type+"/y_axes")),     // y axis label
        	renderer
        	);
