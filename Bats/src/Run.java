...

{
	 ...
	 * Exception: for radiocarbon this is already an uncorrected F14C value! (without d13 correction)
	 */
	...
	/**
	 * d13 corrected f14C value (for radiocarbon only)
	 */
	public Double f14c;	
	/**
	 * error of f14C
	 */
	public Double f14c_err;	
	/**
	 * sigma of f14C
	 */
...
//			}
			if (returnVal != null) {
			    returnVal = returnVal.toString().replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");
			}
	...
	public void setValue( String value, String name ) {
		try {
			if (name==null) {log.debug("setValue failed");}/*log.debug("Set value of "+name+" is null!"value==null||)*/
			else { try {if (value.equals("null")) {value=null;}} catch (NullPointerException e) {value=null;}// if (value.equals("null")){value=null;}
			if (name.equals("no")){;}
			else if (name.equals("a")) { try {a = Double.valueOf(value);} catch (NullPointerException e) {a=null;}}
			else if (name.equals("a_c")) { try {a = Double.valueOf(value)/runtime_b*1000000;} catch (NullPointerException e) {;} }
			else if (name.equals("a_amp")) { try {a = Double.valueOf(value)*1000000;} catch (NullPointerException e) {;} }
			else if (name.equals("a_err")) { try {a_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("a_nano")) { try {a = Double.valueOf(value)/1000;} catch (NullPointerException e) {;} }
			else if (name.equals("a_cur")) { try {a_cur = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("a_cur_err")) { try {a_cur_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("age")) { try {age = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("age_err")) { try {age_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ana")) { try {ana = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("anb")) { try {anb = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ana_amp")) { try {ana = Double.valueOf(value)*1000000;} catch (NullPointerException e) {;} }
			else if (name.equals("anb_amp")) { try {anb = Double.valueOf(value)*1000000;} catch (NullPointerException e) {;} }
			else if (name.equals("anbana")) { try {anbana = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("anbana_err")) { try {anbana_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("anban_sig")) { try {anban_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("anbansig")) { try {anban_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("asym")) { try {asym = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("b")) { try {b = Double.valueOf(value);} catch (NullPointerException e) {b=null;} }
			else if (name.equals("b_c")) { try {b = Double.valueOf(value)/runtime_b*1000000;} catch (NullPointerException e) {;} }
			else if (name.equals("b_amp")) { try {b = Double.valueOf(value)*1000000;} catch (NullPointerException e) {;} }
			else if (name.equals("b_err")) { try {b_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("b_nano")) { try {b = Double.valueOf(value)/1000;} catch (NullPointerException e) {;} }
			else if (name.equals("b_cur")) { try {b_cur = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("b_err")) { try {b_cur_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba")) { try {ba = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba_pc")) { try {ba = Double.valueOf(value)/100;} catch (NullPointerException e) {;} }
			else if (name.equals("ba_sig_p")) { try {ba_sig = Double.valueOf(value)/100*ba;} catch (NullPointerException e) {;} }
			else if (name.equals("ba_sig")) { try {ba_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("basig")) { try {ba_sig = Double.valueOf(value)/100*ba;} catch (NullPointerException e) {;} }
			else if (name.equals("ba_err")) { try {ba_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba_cur")) { try {ba_cur = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba_cur_err")) { try {ba_cur_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba_cur_sig")) { try {ba_cur_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba_fin")) { try {ba_fin = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba_fin_err")) { try {ba_fin_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ba_fin_sig")) { try {ba_fin_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("std_ba")) { try {std_ba = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("std_ba_err")) { try {std_ba_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("std_ba_sig")) { try {std_ba_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("carrier")) { try {sample.carrier = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("commentinfo")) { try {sample.desc1 = String.valueOf(value);} catch (NullPointerException e) {;} }  	
			else if (name.equals("corrIndex")) { try {corr_index = Integer.valueOf(value);} catch (NumberFormatException e) {;} }  	
			else if (name.equals("corr_index")) { try {corr_index = Integer.valueOf(value);} catch (NumberFormatException e) {;} }  	
			else if (name.equals("cycles")) { try {cycles = Integer.valueOf(value);} catch (NumberFormatException e) {cycles=null;} }
			else if (name.equals("cycle")) { try {cycles = Integer.valueOf(value);} catch (NumberFormatException e) {cycles=null;} }
			else if (name.equals("g1")) { try {g1 = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g1a")) { try {g1a = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g1b")) { try {g1b = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g1_err")) { try {g1_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g1del")) { try {g1_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g2")) { try {g2 = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g2a")) { try {g2a = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g2b")) { try {g2b = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g2_err")) { try {g2_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("g2del")) { try {g2_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("iso")) { try {iso = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("iso")) { try {iso = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("iso_err")) { try {iso_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
//			else if (name.equals("iso1")) { try {iso1 = Double.valueOf(value);} catch (NullPointerException e) {;} }
//			else if (name.equals("iso2")) { try {iso2 = Double.valueOf(value);} catch (NullPointerException e) {;} }
//			else if (name.equals("iso3")) { try {iso3 = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("label")) { try {sample.label = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("sample_nr")) { try {sample.sample_nr = Integer.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("prep_nr")) { try {sample.prep_nr = Integer.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("target_nr")) { try {sample.target_nr = Integer.valueOf(value);} catch (NumberFormatException e) {;} }
			else if (name.equals("recno")) { try {recno= Integer.valueOf(value);} catch (NumberFormatException e) {;} }
			else if (name.equals("magazine")) { try {sample.magazine = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("posit")) { try {sample.posit = Integer.valueOf(value);} catch (NumberFormatException e) {;} }
			else if (name.equals("position")) { try {sample.posit = Integer.valueOf(value);} catch (NumberFormatException e) {;} }
			else if (name.equals("r")) { try {r = Double.valueOf(value);} catch (NullPointerException e) {r=null;} }
			else if (name.equals("rdel")) { try {r_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("r_cor")) { try {r_cor = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra")) { try {ra = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_err")) { try {ra_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_sig_p")) { try {ra_sig = Double.valueOf(value)/100*ra;} catch (NullPointerException e) {;} }
			else if (name.equals("ra_sig")) { try {ra_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rasig")) { try {ra_sig = Double.valueOf(value)*1E10*ra;} catch (NullPointerException e) {;} }
			else if (name.equals("ra_cur")) { try {ra_cur = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_cur_err")) { try {ra_cur_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_cur_sig")) { try {ra_cur_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_bg")) { try {ra_bg = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_bg_sig")) { try {ra_bg_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_bg_err")) { try {ra_bg_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_fin")) { try {ra_fin = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_fin_err")) { try {ra_fin_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_fin_sig")) { try {ra_fin_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_bl")) { try {ra_bl = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_bl_err")) { try {ra_bl_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("ra_bl_sig")) { try {ra_bl_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("std_ra")) { try {std_ra = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("std_ra_err")) { try {std_ra_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("std_ra_sig")) { try {std_ra_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("active")||name.equals("ratrue")) { try {
				if(value.equals("+")||value.equals("*")||value.equals("0")||value.equals("false")) {
					active=false;
				} else {
					active=true;
				}
			} catch (NullPointerException e) {active=true;} }
			else if (name.equals("rb")) { try {rb = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rb_err")) { try {rb_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rb_sig_p")) { try {rb_sig = Double.valueOf(value)/100*rb;} catch (NullPointerException e) {;} }
			else if (name.equals("rb_sig")) { try {rb_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rbsig")) { try {rb_sig = Double.valueOf(value)*1E10*rb;} catch (NullPointerException e) {;} }
			else if (name.equals("rb_cur")) { try {rb_cur = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rb_cur_err")) { try {rb_cur_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rb_cur_sig")) { try {rb_cur_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rb_bg")) { try {rb_bg = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rb_bg_err")) { try {rb_bg_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rb_bg_sig")) { try {rb_bg_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("r_err")) { try {r_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
//cv
			else if (name.equals("rs_fin")) { try {rs_fin = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rs_fin_err")) { try {rs_fin_err = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("rs_fin_sig")) { try {rs_fin_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
//cv
//			else if (name.equals("recno")) { try {recno = Integer.valueOf(value);} catch (NumberFormatException e) {;} }
			else if (name.equals("run")) { try {run = String.valueOf(value);
				String number = "";
				...
				try {recno=Integer.valueOf(number);} catch (NumberFormatException e) {log.error("Recno of "+run+" was not an integer: "+number);}
			} catch (NullPointerException e) {;} }
			else if (name.equals("runtime")) { try {runtime = Double.valueOf(value);} catch (NullPointerException e) {runtime=null;} }
			else if (name.equals("runtime_nec")) { try {runtime = Double.valueOf(value)/10;} catch (NullPointerException e) {;} }
			else if (name.equals("runtime_a")) { try {runtime_a = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("runtime_b")) { try {runtime_b = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("runtime_hv")) { try {runtime = Double.valueOf(value)*runtime_g1;} catch (NullPointerException e) {;} }
			else if (name.equals("runtime_a_hv")) { try {runtime_a = Double.valueOf(value)*runtime_g1;} catch (NullPointerException e) {;} } 	
			else if (name.equals("runtime_b_hv")) { try {runtime_b = Double.valueOf(value)*runtime_g1;} catch (NullPointerException e) {;} } 	
			else if (name.equals("runtime_g1")) { try {runtime_g1 = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("runtime_g2")) { try {runtime_g2 = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("dt_r")) { try {dt_r = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("dt_a")) { try {dt_a = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("dt_b")) { try {dt_b = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("dt_g1")) { try {dt_g1 = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("dt_g2")) { try {dt_g2 = Double.valueOf(value);} catch (NullPointerException e) {;} } 	
			else if (name.equals("strippr")) { try {stripper = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("stripper")) { try {stripper = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("sample_year")) { try {sample.sample_date.set(Integer.valueOf(value),0,1);} catch (NumberFormatException e) {;} }
			else if (name.equals("sampletype")) { try {sample.type = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("timedatora")) { try {
			...
			else if (name.equals("timedat")) { try {
				SimpleDateFormat df = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss z");
//				log.debug(df.format(new Date()));
			...
			else if (name.equals("date")) { try {
				SimpleDateFormat df = new SimpleDateFormat( "yyyyMMdd" );
				try {
					timedat=df.parse(value);
				} catch (ParseException e) { log.debug("Wrong date format: "+value); }
			} catch (NullPointerException e) {;} } 
			else if (name.equals("date_hv")) { try {
				SimpleDateFormat df = new SimpleDateFormat( "dd/MM/yyyy hh:mm:ss aaa" );
				try {
					timedat=df.parse(value);
				} catch (ParseException e) { log.debug("Wrong date format: "+value); }
			} catch (NullPointerException e) {;} } 
			else if (name.equals("date_hv2")) { try {
				SimpleDateFormat df = new SimpleDateFormat( "dd-MMM-yy hh:mm:ss aaa" );
				try {
					timedat=df.parse(value);
				} catch (ParseException e) { log.debug("Wrong date format: "+value); }
			} catch (NullPointerException e) {;} } 
			else if (name.equals("time_nec")) { try {
				SimpleDateFormat df = new SimpleDateFormat( "EEE MMM d HH:mm:ss yyyy" );
				try {
					timedat=df.parse(value);
				} catch (ParseException e) { log.debug("Wrong date format: "+value); }
			} catch (NullPointerException e) {;} } 
			else if (name.equals("time_eu")) { try {
				SimpleDateFormat df = new SimpleDateFormat( "HH:mm" );
				try {
					timedat=df.parse(value);
				} catch (ParseException e) { log.debug("Wrong date format: "+value); }
			} catch (NullPointerException e) {;} } 
			else if (name.equals("time")) { try {
				timedat.setTime(timedat.getTime()+Integer.valueOf(value.substring(0,2))*3600000
						+Integer.valueOf(value.substring(3,5))*60000);
			} catch (NullPointerException e) {;} }
			else if (name.equals("timestamp")) { try {
				SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
				try { 
					timedat=df.parse(value);
				} catch (ParseException e) { log.debug("Wrong date format: "+value); }
			} catch (NullPointerException e) {;} }
			else if (name.equals("time_hv3")) { try {
				SimpleDateFormat df = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
				try { 
					timedat=df.parse(value);
				} catch (ParseException e) { log.debug("Wrong date format: "+value); }
			} catch (NullPointerException e) {;} }
			else if (name.equals("tra")) { try {tra = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("tra_sig")) { try { tra_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("trasig")) { try { tra_sig = Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("username")) { try {sample.username = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("userlabel")) { try {sample.userlabel = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("userlabel_nr")) { try {sample.userlabel_nr = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("desc1")) { try {sample.desc1 = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("desc2")) { try {sample.desc2 = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("target_comm")) { try {sample.target_comm = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("prep_bl")) { try {sample.prep_bl= Double.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("project")) { try {sample.project = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("priority")) { try {sample.priority = Integer.valueOf(value);} catch (NumberFormatException e) {;} }
			else if (name.equals("material")) { try {sample.material = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("fraction")) { try {sample.fraction = String.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("weight")) { try {sample.weight = Double.valueOf(value);} catch (NullPointerException e) {;} }	
//			else if (name.equals("editable")) { try {editable = Boolean.valueOf(value);} catch (NullPointerException e) {;} }
			else if (name.equals("reduced")) { try {reduced = Boolean.valueOf(value);} catch (NullPointerException e) {;} }
			else { try {
	...
	//			JOptionPane.showMessageDialog( null, message );
		...
		catch (NumberFormatException e) {log.debug(e);}
	}
...
//cv
			else if (name.equals("pmC")) { return f14c*100; }
			else if (name.equals("pmC_err")) { return f14c_err*100; }
			else if (name.equals("pmC_sig")) { return f14c_sig*100; }
			else if (name.equals("pmC_errR")) { return f14c_err/f14c; }
			else if (name.equals("pmC_sigR")) { return f14c_sig/f14c; }
			else if (name.equals("pmC_chi")) { return Math.pow(f14c_sig/f14c,2)/Math.pow(ra_cur_err/ra_bl,2); } 	
			else if (name.equals("pmC_a")) { return f14c*100/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/8223); }
			else if (name.equals("pmC_a_err")) { return f14c_err*100/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/8223); }
			else if (name.equals("pmC_a_sig")) { return f14c_sig*100/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/8223); }
			else if (name.equals("pmC_a_errR")) { return f14c_err/f14c; }
			else if (name.equals("pmC_a_sigR")) { return f14c_sig/f14c; }
...
//			else if (name.equals("pmC_today_sigR")) { return pmC_sig/pmC; }
			else if (name.equals("fM")) { return f14c; }
			else if (name.equals("fM_err")) { return f14c_err; }
			else if (name.equals("fM_sig")) { return f14c_sig; }
			else if (name.equals("fM_errR")) { return f14c_err/f14c; }
			else if (name.equals("fM_a")) { return f14c/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/826700); }
			else if (name.equals("fM_a_err")) { return f14c_err/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/826700); }
			else if (name.equals("fM_a_errR")) { return f14c_err/f14c; }
			else if (name.equals("D14")) { return (Math.exp((1950-Calendar.YEAR)/8267)*Math.exp(-age/8033)-1); }
			...
			else if (name.equals("ra_fin2")) { return ra_fin/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/8223)*1.1822; }
			else if (name.equals("ra_fin2_err")) { return Math.sqrt(Math.pow(1.1822*ra_fin_err/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/8223),2)+Math.pow(0.010E-14,2)); }
			else if (name.equals("ra_fin2_sig")) { return Math.sqrt(Math.pow(1.1822*ra_fin_sig/Math.exp((sample.sample_date.get(Calendar.YEAR)-1950.0)/8223),2)+Math.pow(0.010E-14,2)); }
...
//cv
			...
			else if (name.equals("sample_year")) { return sample.sample_date.get(Calendar.YEAR); }
			else if (name.equals("sample_date")) { return sample.sample_date.get(Calendar.YEAR); }
			...
			else if (name.equals("editable")) {return sample.editable;}
