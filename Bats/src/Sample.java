...
public class Sample implements DataSet, Cloneable {
	private static final Logger log = LogManager.getLogger("Sample");
	/**  	 *   	 */  	
	public Double a;
	/**  	 *   	 */  	
	public Double a_cur; 	
...
//			log.debug(df.format(new Date()));
		...
		else if (name.equals("prep_method")) {prep_method = String.valueOf(value);}
		...
		else if (name.equals("reactor_nr")) {reactor_nr = Integer.valueOf(value);}	
		else if (name.equals("editable")) {editable = Integer.valueOf(value);}
		else {
...
//			else if (name.equals("run")) {run = (String)value;}
			...
			else if (name.equals("prep_method")) {prep_method = (String)value;}
			...
			else if (name.equals("reactor_nr")) {reactor_nr = (Integer) value;}
			else if (name.equals("editable")) {editable = (Integer) value;}
			else if (name.equals("readonly")) {readonly = (Boolean) value;}
			else if (name.equals("cal_curve")) {cal_curve = (String) value;}
	...
	public Object get(String name){
		try {
			...
			else if (name.equals("cal_curve")) { return cal_curve; } 	
...
//			else if (name.equals("iso3")) { return iso3; }
			...
			else if (name.equals("fM_a")) { return f14c/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8267); }
			else if (name.equals("fM_a_err")) { return f14c_err/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8267); }
			else if (name.equals("fM_a_errR")) { return f14c_err/f14c; }
			else if (name.equals("D14")) { return (f14c*Math.exp((1950-sample_date.get(Calendar.YEAR))/8267)-1); }
			...
			else if (name.equals("pmC_a")) { return f14c*100/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8267); }
			else if (name.equals("pmC_a_err")) { return f14c_err*100/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8267); }
			else if (name.equals("pmC_a_sig")) { return f14c_sig*100/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8267); }
...
//cv
			...
			else if (name.equals("ra_fin2")) { return ra_fin/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8223)*1.1822; }
			else if (name.equals("ra_fin2_err")) { return Math.sqrt(Math.pow(1.1822*ra_fin_err/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8223),2)+Math.pow(0.010E-2,2)); }
			else if (name.equals("ra_fin2_sig")) { return Math.sqrt(Math.pow(1.1822*ra_fin_sig/Math.exp((sample_date.get(Calendar.YEAR)-1950.0)/8223),2)+Math.pow(0.010E-2,2)); }
			...
			else if (name.equals("sample_year")) { return sample_date.get(Calendar.YEAR); }
			else if (name.equals("sample_date")) { return sample_date.get(Calendar.YEAR); }
			...
			else if (name.equals("prep_method")) { return prep_method; }	
			...
			else if (name.equals("reactor_nr")) { return reactor_nr; }	
