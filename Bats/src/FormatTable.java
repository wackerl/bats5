...
public class FormatTable extends JPanel implements WindowListener{    
	...
	private static final Logger log = LogManager.getLogger("FormatTable");
    ...
    ArrayList<Serializable> formatList= new ArrayList<Serializable>();	
	String[] name = {
			"name",
			"value",
			"column width",
...
//	    table.setDefaultRenderer(Boolean.class, renderer);
    ...
    public void updateTable(FormatT format) {
    	this.format = format;
    	formatList=null;
    	formatList = new ArrayList<Serializable>();
	    formatList.add(format.colName);
	    formatList.add(format.colValName);
	    formatList.add(format.colWidth);
	    formatList.add(format.colFormat);
