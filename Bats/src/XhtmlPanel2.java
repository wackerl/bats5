 ...
 *
 */
public class XhtmlPanel2 extends JPanel {
	private static final Logger log = LogManager.getLogger("XhtmlPanel");
	private XHTMLPanel xp;
	private XhtmlFile fileX;
	private File file;
	FormatT format;
	
	XhtmlPanel2(Calc data, String fileName, FormatT format) {
	this.format = format;
	...
	public void update(Calc data, String fileName) {
    	...
    	if (!Setting.no_data) {
			...
			log.debug("finished xhtml update");
    	}
	}
