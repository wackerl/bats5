...
public interface DbConnect {
	...
	/**
	 * @return get Standards and blanks
	 * 
	 */
	abstract public ArrayList<StdData> getStd();
	 ...
	 *
	 */
	abstract public void openCalcSelect();
	
	/**
	 * @param calcset 
	 *
	 */
	abstract public void openCalc(String calcset);
