...
public class GraphIso2 implements WindowListener {
	private static final Logger log = LogManager.getLogger("GraphIso2");
...
//    JFormattedTextField textField;
   ...
   JFormattedTextField slopeField;
	...
	public GraphIso2(Bats main, String type) {
		...
		JLabel textLabel = new JLabel("Isobar correction on radioisotope:", SwingConstants.LEFT);  		
		textLabel.setAlignmentX(Component.RIGHT_ALIGNMENT);

		JLabel textLabel2 = new JLabel(Setting.getString("/bat/isotope/graph/"+type+"/unit"), SwingConstants.LEFT);  		
